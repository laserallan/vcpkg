...
vcpkg_apply_patches(
    SOURCE_PATH ${CURRENT_BUILDTREES_DIR}/src/openexr-2.2.0
    PATCHES "${CMAKE_CURRENT_LIST_DIR}/use-pkgconfig-for-ilmbase.patch"
)
...
#    OPTIONS -DILMBASE_PACKAGE_PREFIX=${PRE_PACKAGES_DIR}
    OPTIONS_RELEASE -DCMAKE_EXE_LINKER_FLAGS=/LIBPATH:"${PRE_PACKAGES_DIR}/lib" -DCMAKE_SHARED_LINKER_FLAGS=/LIBPATH:"${PRE_PACKAGES_DIR}/lib"
    OPTIONS_DEBUG -DCMAKE_EXE_LINKER_FLAGS=/LIBPATH:"${PRE_PACKAGES_DIR}/debug/lib" -DCMAKE_SHARED_LINKER_FLAGS=/LIBPATH:"${PRE_PACKAGES_DIR}/debug/lib" 
)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL static)
	...
	file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/share/doc ${CURRENT_PACKAGES_DIR}/debug/share)
endif()
